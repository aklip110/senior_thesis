...
bzleft12 = []
for i in range(lengthOn):
    if (dat12[i, 2] == -34500) and (dat12[i, 1] == -50) :
        ...
        bz12 += [dat12[i, 7]]
    if (dat12[i, 2] == -34500) and (dat12[i, 1] == 7950) :
...
bzleft29 = []
for i in range(lengthOn):
    if (dat29[i, 2] == -17500) and (dat29[i, 1] == -50) :
        ...
        bz29 += [dat29[i, 7]]
    if (dat29[i, 2] == -17500) and (dat29[i, 1] == 7950) :
...
bzXleft = []
for i in range(lengthOn):
    if (datX[i, 2] == -51500) and (datX[i, 1] == 11950) :
        ...
        bzX += [datX[i, 7]]
    if (datX[i, 2] == -51500) and (datX[i, 1] == 3950) :
...
bzXleft12 = []
for i in range(lengthOn):
    if (datX12[i, 2] == -34500) and (datX12[i, 1] == 11950) :
        ...
        bzX12 += [datX12[i, 7]]
    if (datX12[i, 2] == -34500) and (datX12[i, 1] == 3950) :
...
bzXleft29 = []
for i in range(lengthOn):
    if (datX29[i, 2] == -17500) and (datX29[i, 1] == 11950) :
        ...
        bzX29 += [datX29[i, 7]]
    if (datX29[i, 2] == -17500) and (datX29[i, 1] == 3950) :
