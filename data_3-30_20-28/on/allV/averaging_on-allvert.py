...
#will be array of on data used throughout
Offdat = np.zeros(13)

#grab on data prior to t1/2
...
#np.savetxt("averaged_on--51500.txt", avgd_dat, delimiter=" ")
...
bz = []
for i in range(length):
    if (dat[i, 2] == -51500) and (dat[i, 1] == -50) :
        y += [(22.7 / 30000) * (dat[i,0] - T0)]
        bx += [dat[i,3]]
        by += [dat[i,7]]
        bz += [-dat[i, 5]]
    if (dat[i, 2] == -51500) and (dat[i, 1] == 7950) :
        y += [(22.7 / 30000) * (-(dat[i,0] - T0))]
        bx += [-dat[i,3]]
        by += [-dat[i,7]]
        bz += [-dat[i, 5]]
...
bz29 = []
for i in range(length):
    if (dat[i, 2] == -17500) and (dat[i, 1] == -50) :
        y29 += [(22.7 / 30000) * (dat[i,0] - T0)]
        bx29 += [dat[i,3]]
        by29 += [dat[i,7]]
        bz29 += [-dat[i, 5]]
    if (dat[i, 2] == -17500) and (dat[i, 1] == 7950) :
        y29 += [(22.7 / 30000) * (-(dat[i,0] - T0))]
        bx29 += [-dat[i,3]]
        by29 += [-dat[i,7]]
        bz29 += [-dat[i, 5]]
...
bz = []
for i in range(length):
    if (dat[i, 2] == -51500) and (dat[i, 1] == 11950) :
        x += [(22.7 / 30000) * (dat[i,0] - T0)]
        bx += [dat[i,7]]
        by += [-dat[i,3]]
        bz += [-dat[i, 5]]
    if (dat[i, 2] == -51500) and (dat[i, 1] == 3950) :
        x += [(22.7 / 30000) * (-(dat[i,0] - T0))]
        bx += [-dat[i,7]]
        by += [dat[i,3]]
        bz += [-dat[i, 5]]
...
bz_avgdL = []
for i in range(len(avgd_dat)):
    if (avgd_dat[i, 2] == -51500) and (avgd_dat[i, 1] == 11950):
        x_avgd += [(22.7 / 30000) * (avgd_dat[i,0] - T0)]
        bx_avgd += [avgd_dat[i,7]]
        by_avgd += [-avgd_dat[i,3]]
        bz_avgd += [-avgd_dat[i,5]]
    if (avgd_dat[i, 2] == -51500) and (avgd_dat[i, 1] == 3950):
...
bz29 = []
for i in range(length):
    if (dat[i, 2] == -17500) and (dat[i, 1] == 11950) :
        x29 += [(22.7 / 30000) * (dat[i,0] - T0)]
        bx29 += [dat[i,7]]
        by29 += [-dat[i,3]]
        bz29 += [-dat[i, 5]]
    if (dat[i, 2] == -17500) and (dat[i, 1] == 3950) :
        x29 += [(22.7 / 30000) * (-(dat[i,0] - T0))]
        bx29 += [-dat[i,7]]
        by29 += [dat[i,3]]
        bz29 += [-dat[i, 5]]
...
bz_avgdL29 = []
for i in range(len(avgd_dat)):
    if (avgd_dat[i, 2] == -17500) and (avgd_dat[i, 1] == 11950):
        x_avgd29 += [(22.7 / 30000) * (avgd_dat[i,0] - T0)]
        bx_avgd29 += [avgd_dat[i,7]]
        by_avgd29 += [-avgd_dat[i,3]]
        bz_avgd29 += [-avgd_dat[i,5]]
    if (avgd_dat[i, 2] == -17500) and (avgd_dat[i, 1] == 3950):
