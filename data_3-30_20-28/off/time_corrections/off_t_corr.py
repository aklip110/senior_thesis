...
plt.title("Change in single-axis probe reading over time: off")
plt.tight_layout()
plt.savefig("SA_off_avg--" + str(interval) + ".png", dpi=1000)
plt.show()
...
plt.title("Change in single-axis probe deviation over time: off")
plt.tight_layout()
plt.savefig("SA_off_deviation--" + str(interval) + ".png", dpi=1000)
plt.show()

#now take code from the averaging_off-34500.py script
...
np.savetxt("averaged_off_rot_timecorr-"+ str(interval)+ ".txt", avgd_rot_tcorr_dat, delimiter=" ")
np.savetxt("averaged_off_rot-"+ str(interval)+ ".txt", avgd_rot_dat, delimiter=" ")
...
plt.xlabel("x (cm)")
plt.ylabel("Bx (mG)")
plt.title("Bx (along B0) vs x: off, time corrected")
plt.savefig("Bx_x-avg-off-tcorr-compare-"+ str(interval)+ ".png", dpi=1000)
plt.show()
...
plt.xlabel("y (cm)")
plt.ylabel("Bx (mG)")
plt.title("Bx (along B0) vs y: off, time corrected")
plt.savefig("Bx_y-avg-off-tcorr-compare-"+ str(interval)+ ".png", dpi=1000)
plt.show()
