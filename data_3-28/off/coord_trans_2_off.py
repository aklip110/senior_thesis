...
pd.DataFrame(lab_dat).to_csv("/Users/alexandraklipfel/Desktop/transformed_off.csv")
...
#################################
#fixed
x1 = get_vals(lab_dat, "y", -4300., heights[0], 1)[0]
y1 = get_vals(lab_dat, "y", -4300., heights[0], 1)[1]

x2 = get_vals(lab_dat, "y", -4300., heights[1], 1)[0]
y2 = get_vals(lab_dat, "y", -4300., heights[1], 1)[1]

x3 = get_vals(lab_dat, "y", -4300., heights[2], 1)[0]
y3 = get_vals(lab_dat, "y", -4300., heights[2], 1)[1]
...
################################
#fixed
x1 = get_vals(lab_dat, "x", -4300., heights[0], 0.01)[0]
y1 = get_vals(lab_dat, "x", -4300., heights[0], 0.01)[1]

x2 = get_vals(lab_dat, "x", -4300., heights[1], 0.01)[0]
y2 = get_vals(lab_dat, "x", -4300., heights[1], 0.01)[1]

x3 = get_vals(lab_dat, "x", -4300., heights[2], 0.01)[0]
y3 = get_vals(lab_dat, "x", -4300., heights[2], 0.01)[1]
...
################################
#fixed
x1 = get_vals(lab_dat, "z", -4300., heights[0], 0.01)[0]
y1 = get_vals(lab_dat, "z", -4300., heights[0], 0.01)[1]

x2 = get_vals(lab_dat, "z", -4300., heights[1], 0.01)[0]
y2 = get_vals(lab_dat, "z", -4300., heights[1], 0.01)[1]

x3 = get_vals(lab_dat, "z", -4300., heights[2], 0.01)[0]
y3 = get_vals(lab_dat, "z", -4300., heights[2], 0.01)[1]
...
########################
#fixed
x1 = get_mags(lab_dat, -4300., heights[0], 0.01)[0]
y1 = get_mags(lab_dat, -4300., heights[0], 0.01)[1]

x2 = get_mags(lab_dat, -4300., heights[1], 0.01)[0]
y2 = get_mags(lab_dat, -4300., heights[1], 0.01)[1]

x3 = get_mags(lab_dat, -4300., heights[2], 0.01)[0]
y3 = get_mags(lab_dat, -4300., heights[2], 0.01)[1]
