...
np.savetxt("averaged_on.txt", avgd_dat, delimiter=" ")
...
plt.savefig("Bx_z-avg-on.png", dpi=1000)
plt.show()
...
plt.xlabel("z")
plt.ylabel("Bz")
plt.title("Bz vs z: on")
plt.savefig("Bz_z-avg-on.png", dpi=1000)
plt.show()
...
plt.xlabel("z")
plt.ylabel("By")
plt.title("By (vertical) vs z: on")
plt.savefig("By_z-avg-on.png", dpi=1000)
plt.show()
