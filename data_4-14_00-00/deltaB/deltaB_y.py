...
#import off data
fileOff = "/Users/alexandraklipfel/Desktop/senior_thesis/data_4-14/off/averaged_off_rot.txt"
datOff = np.loadtxt(fileOff)

#import on data
fileOn = "/Users/alexandraklipfel/Desktop/senior_thesis/data_4-14/on/averaged_on_rot.txt"
...
plt.xlabel("y (cm)")
plt.ylabel("|B| (mG)")
plt.title("delta |B| vs y: time corrected, different heights")
plt.legend(loc="upper left")
