...
#import data ------------------------------
file = "/Users/alexandraklipfel/Desktop/senior_thesis/data_4-14/data_4-14-3D_scan.txt"
Alldat = np.loadtxt(file)
print("Data Shape: ", Alldat.shape)
length = Alldat.shape[0]

#import z data
zfile = "/Users/alexandraklipfel/Desktop/senior_thesis/data_4-14/data_4-14-vertical_sweep.txt"
...
#--------------------------------------------------------------
#z plots
z = (15.2 / 50000) * (rot_Zdat[:, 2] - V1)
print(z)
zavgd = (15.2 / 50000) * (avgd_rot_Zdat[:, 2] - V1)
...
plt.xlabel("z (cm)")
plt.ylabel("Bx (mG)")
plt.title("Bx (along B0) vs z: on")
plt.savefig("Bx_z-on_V1.png", dpi=500)
plt.show()
...
plt.savefig("Bx_x-on_V1.png", dpi=500)
plt.show()
...
plt.savefig("Bx_y-on_V1.png", dpi=500)
plt.show()
